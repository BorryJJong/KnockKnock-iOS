...
final class ChallengeDetailCell: BaseTableViewCell {
  ...
  override func setupConstraints() {
    [self.titleLabel, self.exampleImageView, self.contentLabel].addSubViews(self.contentView)
    ...
    NSLayoutConstraint.activate([
      ...
      self.contentLabel.topAnchor.constraint(equalTo: self.exampleImageView.bottomAnchor, constant: Metric.contentLabelTopMargin),
      ...
      self.contentLabel.bottomAnchor.constraint(equalTo: self.contentView.bottomAnchor, constant: Metric.contentLabelBottomMargin),
    ])
  }
}
